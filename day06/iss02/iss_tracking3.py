...
while True:
    ...
    display()
    if yellowlat == 0: yellowlat = float(input('What is your latitude? '))
    if yellowlon == 0: yellowlon = float(input('What is your longitude? '))
    else:
        ...
        re = turtle.textinput('Reload', 'Enter r for reload, q to quit')
        if re is 'r':
            continue
        else:
            break 
