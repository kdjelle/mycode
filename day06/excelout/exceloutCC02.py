...
def get_ip_data():
    ...
    input_car = input("What kind of car does the driver drive? ")
    input_road = input("What street does the driver drive on? ")
    d = {"IP": input_ip, "driver": input_driver, "car": input_car, "road": input_road}
    return d
